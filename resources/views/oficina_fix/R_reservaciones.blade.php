...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('CSS/new/R_reservaciones.css') }}" >
        ...
        <div class="cuerpo-pagina">
            ...
            <div class="contenido">
                <div class="title">
                    <h2>Reservaciones</h2>
                    <h2>-</h2>
                    <h2 style="font-style: oblique; font-weight: 500;">Activas</h2>
                </div>                
                <div class="table">
                    <!-- -->
                    <div class="datatable">
            ...
            <div class="contenido">
                <div class="title">
                    <div class="text_flex">
                        ...
                        <h2 class="title_2">Reservaciones</h2>
                        <h2 class="title_2">-</h2>
                        <h2 class="title_2" style="font-style: oblique; font-weight: 500;">Reservacion</h2>
                        <h2 class="title_2">-</h2>
                        <h2 style="font-style: oblique; font-weight: 500;">Detalles</h2>
                    </div>
                </div>
                <div>
...
<script>
    document.querySelectorAll(".cont-items-categorias")[2].classList.add("categoria-active")
</script>
</html>