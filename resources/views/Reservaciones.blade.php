...
<head>
    ...
    <title>Reserva tu parques</title>
...
<body class="Body" onload="Iluminar()">

    <script>
        let host_ruta = '{{ url('/solicitud_estado') }}'
    </script>
    
    <div class="cont-logo">
        <!-- -->
        <div class="logo">
            <img src="{{ asset('IMG/Logo_ADN.svg') }}">
        </div>
    </div>
...
<!-- ================================================================================== -->
                ...
                <div class="Form5 NextAnimation">
                    <div class="Carga_icon">
                        <div class="Carga-Display" id="Dis">
                            <svg id="Capa_3" data-name="Capa 2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 381.78 638">
                            <defs>
                                <style>
                                .cls-3 {
                                    fill: #00569c;
                        ...
                        <div>
                            <p id="MCarga" class="Carga-Display">Registrando su reservacion...</p>
                        </div>
                    </div>
                    <!---->
                    <div class="QRView">
                        ...
                        <div class="QRCard">
                            ...
                            <div class="QRinfo">
                                <p>Tu codigo de reservacion es:</p>
                                <h2 id="code_r">---</h2>
                                <p>Para continuar con el proceso, te solicitamos confirmar tu dirección de correo electrónico tan pronto como sea posible.</p>
                            </div>
                        </div>
                        <h4>Agradecemos tu pronta atención a este asunto. Si tienes alguna pregunta o necesitas asistencia, no dudes en ponerte en contacto con nosotros.</h4>
                        <div class="return_div">
                            <p class="return_btn" onclick="reload()">Regresar a la pagina principal</p>
                        </div>
                    </div>
                </div>
    ...
    <div class="toast" role="alert" aria-live="assertive" aria-atomic="true">
        <div class="toast-header">
            ...
            <img src="{{ asset('IMG/Escudo.svg') }}" class="rounded me-2 toast_svg" alt="...">
            <!--
            ...
            -->
            <button type="button" class="btn-close" data-bs-dismiss="toast" aria-label="Close" onclick="Hide_flotante()"></button>
        </div>
...
<script src="{{ asset('JS/front/step3/fecha_hora.js') }}"></script>
