...
<head>
    ...
    <title>Reservaciones - Estado</title>
    <link rel="stylesheet" href="/CSS/new/solicitud_estado.css">
    <link rel="stylesheet" href="{{ asset('CSS/headerFooter.css') }}"> <!-- CONECTAR CSS -->
    <link rel="stylesheet" href="/CSS/adn_carga_animacion.css">
    <link rel="stylesheet" href="{{asset('CSS/modal_estructura.css')}}">

    <script src="{{ asset('JS/peticiones.js') }}"></script>
    <script src="{{ asset('JS/mantenimientos/QR_maker.js') }}"></script>
    ...
    <script src="/JS/mantenimientos/reservacion_estado.js"></script>

</head>
<body class="Home">
    <div class="logo_adn">
        <img src="/IMG/Logo_ADN.svg">
    </div>

    <div class="estructura_principal">
        <div class="contenedor_central">
            <section class="box_header">
                <p>Codigo de reservacion</p>
                <div class="input_buscador" >
                    <input type="text" class="input_objeto">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" onclick="reservacion_get()"><!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><path d="M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z"/></svg>
                </div>
            </section>
            <section class="box_middle">
                <div class="middle_contenido">
                    <div class="reservacion_informe">
                        <div class="info_section">
                            <div class="prueba_svg">
                            ...
                            <div class="info_middle">
                                <div class="data_info">
                                    ...
                                    <h4 class="user_info">Andy Elieser Torres Lara</h4>
                                </div>
                                <div class="data_info">
                                    <p class="user_info">Cedula/Pasaporte</p>
                                    <h4 class="user_info">123-45678912-3</h4>
                                </div>
                                <div class="data_info">
                                    <p>Correo</p>
                                    <h4 class="user_info">Andyeliezerdh@gmail.com</h4>    
                                </div>
                                <div class="data_info">
                                    <p>Celular</p>
                                    <h4 class="user_info">829-5658-477</h4>
                                </div>
                            </div>    
                        </div>
                        ...
                        <div class="info_section">
                            ...
                            <div class="info_header">
                                <p>Informacion de la reservacion</p>
                            </div>
                            <div class="info_middle">
                                <div class="data_info">
                                    <p>Codigo de reservacion</p>
                                    <h4 class="reservacion_info">PRM#30123</h4>
                                </div>
                                <div class="data_info">
                                    <p>Responsables</p>
                                    <h4 class="reservacion_info">Yo</h4>    
                                </div>
                                <div class="data_info">
                                    <p>Motivo del evento</p>
                                    <h4 class="reservacion_info">Cumpleaños</h4>    
                                </div>
                                <div class="data_info">
                                    <p>Fecha del evento</p>
                                    <h4 class="reservacion_info">2023-05-17</h4>    
                                </div>
                                <div class="data_info">
                                    <p>Desde - Hasta</p>
                                    <h4 class="reservacion_info">12:30 - 5:00</h4>    
                                </div>
                                <div class="data_info">
                                    <p>Adultos participantes</p>
                                    <h4 class="reservacion_info">17</h4>
                                </div>
                                <div class="data_info">
                                    <p>Niños participantes</p>
                                    <h4 class="reservacion_info">25</h4>
                                </div>
                                <div class="data_info">
                                    <p>Descripcion</p>
                                    <h4 class="reservacion_info reservacion_informe_descripcion">Lorem ipsum dolor sit amet consectetur adipisicing elit. Deleniti velit mollitia modi debitis quae officia, iusto aperiam? Facere repudiandae maiores eius non qui consectetur. Ea quas nobis reiciendis odit autem.</h4>    
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="info_section">
                            ...
                            <div class="info_header">
                                <p>Informacion del parque y gazebo</p>
                            </div>
                            <div class="info_middle">
                                <div class="data_info">
                                    <p>Nombre del parque</p>
                                    <h4 class="parque_info">Mirador sur</h4>    
                                </div>
                                <div class="data_info">
                                    <p>Direccion del parque</p>
                                    <h4 class="parque_info">Del Sur, Av. Mirador Sur, Santo Domingo</h4>    
                                </div>
                                <div class="data_info">
                                    <p>Nombre del gazebo</p>
                                    <h4 class="parque_info">Gazebo #5  Caonabo</h4>    
                                </div>
                                <div class="data_info">
                                    <p>Direccion del gazebo</p>
                                    <h4 class="parque_info">Camino Anacaona, Santo Domingo, Republica dominicana</h4>    
                                </div>
                                <!-- 
                                <div class="data_info">
                                    <p>Descripcion</p>
                                    <h4 style="text-align:justify">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Id dolorum delectus minus quaerat, obcaecati cum quam quod sequi distinctio cupiditate explicabo et tempora consectetur nostrum neque magnam! At, exercitationem neque?</h4>    
                                </div>
                                -->
                            </div>    
                        </div>
                        ...
                        <div class="info_section">
                            ...
                            <div class="info_header">
                                <p>Localizacion y contactos</p>
                            </div>
                            <div class="info_middle">
                                <div class="data_info">
                                    <p>Correo</p>
                                    <h4 class="extra_info">MiradorSur@Gmail.com</h4>    
                                </div>
                                <div class="data_info">
                                    <p>Telefono</p>
                                    <h4 class="extra_info">829-5658-477</h4>    
                                </div>

                                <div class="data_info">
                                    <p>Provincia</p>
                                    <h4 class="extra_info">Ciudad Santo Domingo Distrito Nacional</h4>    
                                </div>
                                <div class="data_info">
                                    <p>Municipio</p>
                                    <h4 class="extra_info">Santo domingo</h4>    
                                </div>
                                <div class="data_info">
                                    <p>Sector</p>
                                    <h4 class="extra_info">Santo domingo</h4>    
            ...
            <div class="Carga_icon">
                ...
                <div>
                    <p id="MCarga" class="Carga-Display">Obteniendo informacion...</p>
                </div>
            </div>
            <!-- ======================================================= -->
    ...
    @if ($id ?? false)
        <script>
            document.querySelector('.box_header').style.display = 'none'
            reservacion_get({{ $id }})
        </script>
    @else
    @endif
